...
db.once('open', function(e) {
    console.log('Database connected! Items:', itIds)
        //checking to see if all items have data
    getData(itIds);
})

var Item, parsedPrice, parsedName;
...
itemSchema.virtual('full_route').get(function() {
                    ...
                    function(nResponse) {
                        ...
                        nResponse.on('end', function() {
                            ...
                            parsedPrice.forEach(function(el) {
                                ...
                                Item.findOneAndUpdate(query, data, { upsert: true }, function(err, doc) {
                                    if (err) {
